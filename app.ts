...
var year:any = prompt("Enter Year") 
if(year%4==0){
...
//program # 7: Write a ts program to check whether a character is alphabet or not.
    ...
    var input:any = prompt("enter any alpha, number or char");
...
// Program # 10: Write a ts program to check whether a character is uppercase or lowercase alphabet.
    var a1:any = prompt("Enter Alphabet and check letter is uppercase or lowercase")
 if (a1>= "a" && a1<= "z") {
...
//Program # 12:Write a ts program to input month number and print number of days in that month
    ...
    var angle1:any= parseInt(prompt("Enter Angle A"))
var angle2:any=parseInt (prompt("Enter Angle B"))
var angle3:any=parseInt(prompt("Enter Angle C"))
...
var math:string | null= prompt("Enter MATH MArks");
